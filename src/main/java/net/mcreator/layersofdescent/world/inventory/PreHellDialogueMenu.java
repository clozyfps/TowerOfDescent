...
import net.mcreator.layersofdescent.procedures.DeathMenuTextProcedure;
...
public class PreHellDialogueMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof PreHellDialogueMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			DeathMenuTextProcedure.execute(world, x, y, z, entity);
		}
	}
}
