...
import net.mcreator.layersofdescent.world.teleporter.LimboTeleporter;
import net.mcreator.layersofdescent.world.teleporter.LimboPortalShape;
...
public class LimboPortalBlock extends NetherPortalBlock {
	...
	public void entityInside(BlockState state, Level world, BlockPos pos, Entity entity) {
		if (entity.canChangeDimensions() && !entity.level().isClientSide() && true) {
			...
			} else if (entity.level().dimension() != ResourceKey.create(Registries.DIMENSION, new ResourceLocation("layersofdescent:limbo"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos, ResourceKey.create(Registries.DIMENSION, new ResourceLocation("layersofdescent:limbo")));
			} else {
				entity.setPortalCooldown();
