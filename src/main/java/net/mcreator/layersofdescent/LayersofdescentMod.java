package net.mcreator.layersofdescent;
...
@Mod("layersofdescent")
public class LayersofdescentMod {
	public static final Logger LOGGER = LogManager.getLogger(LayersofdescentMod.class);
	public static final String MODID = "layersofdescent";

	public LayersofdescentMod() {
