...
import net.mcreator.layersofdescent.procedures.SinDisplayProcedure;
import net.mcreator.layersofdescent.procedures.DisplayStrengthTagProcedure;
import net.mcreator.layersofdescent.procedures.DisplayMagicTagProcedure;
import net.mcreator.layersofdescent.procedures.DisplayDexterityTagProcedure;
import net.mcreator.layersofdescent.procedures.DisplayDefenseTagProcedure;
import net.mcreator.layersofdescent.procedures.DisplayAgilityTagProcedure;
import net.mcreator.layersofdescent.network.SinSelectionButtonMessage;
...
public class SinSelectionScreen extends AbstractContainerScreen<SinSelectionMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font,
				...
				DisplayDefenseTagProcedure.execute(entity), -208, 7, -1, false);
		guiGraphics.drawString(this.font,
		...
		guiGraphics.drawString(this.font,
				...
				SinDisplayProcedure.execute(entity), -37, 61, -1, false);
	}
